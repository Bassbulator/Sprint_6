...
class TestOrderPage:
    ...
    @allure.title("Сценарии оформления заказа самоката с разными данными")
    @allure.description("Тест проверяет, что заказ можно оформить с разных точек входа и с разными данными")
    ...
    def test_positive_order_flow_two_datasets(self, driver, base_url, order_data, entry_point):
